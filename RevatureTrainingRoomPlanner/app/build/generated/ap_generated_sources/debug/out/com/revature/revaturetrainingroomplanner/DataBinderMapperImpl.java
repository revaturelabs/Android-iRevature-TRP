...
import com.revature.revaturetrainingroomplanner.databinding.FragmentBatchInfoBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_FRAGMENTBATCHINFO = 5;

  private static final int LAYOUT_FRAGMENTTRAINERSWITHSEARCH = 6;

  private static final int LAYOUT_ROOMROW = 7;

  private static final int LAYOUT_SKILLROW = 8;

  private static final int LAYOUT_TRAINERROW = 9;
  ...
  static {
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.revature.revaturetrainingroomplanner.R.layout.fragment_batch_info, LAYOUT_FRAGMENTBATCHINFO);
  ...
  public ViewDataBinding getDataBinder(DataBindingComponent component, View view, int layoutId) {
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        ...
        case  LAYOUT_FRAGMENTBATCHINFO: {
          if ("layout/fragment_batch_info_0".equals(tag)) {
            return new FragmentBatchInfoBindingImpl(component, view);
          }
          throw new IllegalArgumentException("The tag for fragment_batch_info is invalid. Received: " + tag);
        }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      ...
      sKeys.put("layout/fragment_batch_info_0", com.revature.revaturetrainingroomplanner.R.layout.fragment_batch_info);
