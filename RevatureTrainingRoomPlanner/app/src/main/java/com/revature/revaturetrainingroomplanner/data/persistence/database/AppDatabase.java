...
@Database(entities = {Campus.class, Batch.class, com.revature.revaturetrainingroomplanner.data.model.Room.class, Trainer.class, Skill.class, }, version = 1)
public abstract class AppDatabase extends RoomDatabase {

    public static final String DATABASE_NAME = "revature_training_room_planner_db";
